...
import com.charon.springcloud.alibaba.service.PaymentService;
...
public class CircleBreakerController {
   ...
   // @SentinelResource(value = "fallback",fallback = "handlerFallback")
     ...
     * @return
     */
    public CommonResult blockHandler(@PathVariable(value = "id")  Long id, BlockException blockException) {
        Payment payment = new Payment(id,"null");
